import { PlaylistSongExportProducer } from '../../../../app/producers/playlist-song/playlist-song-export';
...
export class ExportPlaylistSongsUseCase {
  ...
  async execute(payload: { playlistId: string; userId: string }) {
    ...
    await this.playlistSongExportProducer.execute(playlistSongs);
